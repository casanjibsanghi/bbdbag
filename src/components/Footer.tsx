...
const Footer = () => {
  ...
  return <footer className="bg-secondary text-white" role="contentinfo">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-xl overflow-hidden flex items-center justify-center">
                  <img src={bbdLogo} alt="BBD Bag Professional Association Logo" className="w-full h-full object-cover" />
                </div>
                <div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex space-x-4">
                ...
                label,
                tooltip
              }) => <a key={label} href={href} target="_blank" rel="noopener noreferrer" className="group relative w-10 h-10 bg-white/10 rounded-full flex items-center justify-center hover:bg-primary transition-all duration-300" aria-label={tooltip} title={tooltip}>
