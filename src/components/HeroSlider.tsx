...
const HeroSlider = () => {
  ...
  return (
    <section 
      ...
      role="banner"
      aria-label="Hero slider showcasing BBD Bag Professional Association"
    >
      {/* Slides */}
                ...
                <div className="animate-fade-up">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <Button 
                      ...
                      asChild
                    >
                      <a href="/connect">Join the Community</a>
                    </Button>
                    <Button 
                      variant="outline"
                      size="lg"
                      className="btn-outline text-lg px-8 py-3 rounded-xl font-semibold border-white text-white hover:bg-white hover:text-secondary"
                      asChild
                    >
      ...
      <div className="absolute inset-0 flex items-center justify-between p-4 pointer-events-none">
        <Button
          ...
          size="lg"
          onClick={prevSlide}
          className="pointer-events-auto bg-black/20 hover:bg-black/40 text-white border-0 rounded-full w-12 h-12"
      ...
      <div className="absolute bottom-8 right-8">
        <Button
          ...
          className="bg-black/20 hover:bg-black/40 text-white border-0 rounded-full w-10 h-10"
